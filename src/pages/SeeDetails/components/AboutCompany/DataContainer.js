...
const DataContainer = ({ title, description }) => {
  return (
    <>
      ...
      <p className="p_chart_title_l"
        css={`
      margin-bottom:10px !important;
      `}
      >
        <span className="span_square_red" style={{ marginRight: "2px", padding: "0px 8px", borderRadius: "4px" }}>&nbsp;</span> {2020} &nbsp; &nbsp;
        &nbsp;
        <span className="span_border_right_plan">|</span> &nbsp; &nbsp; &nbsp;{" "}
        <span className="span_square_pink" style={{ marginRight: "2px", padding: "0px 8px", borderRadius: "4px" }}>&nbsp;</span> Current Market Premium
        2021
      </p>
      <p
